...
final mockRoadmaps = <RoadmapModel>[
  RoadmapModel(
    ...
    description:
        'Lộ trình thực tế từ ứng dụng React tới hệ thống production đáng tin cậy.',
    category: 'Fullstack',
    difficulty: 'Intermediate',
    estimatedWeeks: 10,
    estimatedHours: 86,
      ...
      RoadmapModuleModel(
        ...
        nodes: [
          _node(
              ...
              description: 'Hieu event loop va cau truc service.',
              status: 'completed',
              hours: 5,
              xp: 160),
          _node(
              id: 'n2',
              title: 'Thiet ke REST API',
              description: 'Mo hinh resource, status code, phan trang.',
              status: 'completed',
              hours: 7,
              xp: 220),
          _node(
              id: 'n3',
              title: 'Validation va error contract',
              description: 'Schema validation va phan hoi loi co kieu.',
              status: 'in-progress',
              hours: 4,
              xp: 180,
              bookmarked: true),
          _node(
              id: 'n4',
              title: 'Xac thuc va rate limit',
              description: 'Bao ve API bang token va throttling.',
              status: 'unlocked',
              hours: 6,
              xp: 260),
        ],
      ...
      RoadmapModuleModel(
        ...
        nodes: [
          _node(
              ...
              description: 'Containerize ung dung va compose stack.',
              status: 'locked',
              hours: 6,
              xp: 200),
          _node(
              ...
              description: 'Pipeline build, test va deploy.',
              status: 'locked',
              hours: 5,
              xp: 190),
        ],
      ...
      RoadmapModuleModel(
        ...
        nodes: [
          _node(
              ...
              description: 'Custom hooks va composition patterns.',
              status: 'in-progress',
              hours: 4,
              xp: 150),
          _node(
              id: 'f2',
              title: 'Testing React',
              description: 'Unit va integration tests.',
              status: 'locked',
              hours: 5,
              xp: 170),
        ],
      ...
      RoadmapModuleModel(
        ...
        nodes: [
          _node(
              ...
              description: 'Resource modeling va HTTP semantics.',
              status: 'unlocked',
              hours: 4,
              xp: 140),
        ],
...
final mockSkillProgress = [
  const SkillProgressModel(
      skill: 'React', category: 'Frontend', current: 85, target: 95),
  const SkillProgressModel(
      skill: 'Node.js', category: 'Backend', current: 58, target: 82),
  const SkillProgressModel(
      skill: 'Docker', category: 'DevOps', current: 34, target: 78),
  const SkillProgressModel(
      skill: 'Testing', category: 'Testing', current: 45, target: 80),
  const SkillProgressModel(
      skill: 'System Design',
...
final mockAIRecommendation = AIRecommendationModel(
  summary:
      'Repository của bạn cho thấy năng lực React tốt, nhưng CI/CD và testing còn hạn chế.',
  confidence: 89,
  strengths: const [
